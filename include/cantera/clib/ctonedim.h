...
extern "C" {
	...
	CANTERA_CAPI int stflow_new(int iph, int ikin, int itr, int itype, int iSurf, int isurfkin, int catIndex, int surfFlag, int surfEnergy);
	CANTERA_CAPI int stflow_setSurfKinetics(int i, int itr);
