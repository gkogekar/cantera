...
#ifndef CT_FlowBase1D_H
#define CT_FlowBase1D_H
...
/**
 *  This class represents 1D flow domains for chemically-reacting flows.
 *  This class is is the base class for stagnation flows and 1D reactors.
 *  @ingroup onedim
 */
class FlowBase1D : public Domain1D
{
public:
    //--------------------------------
	...
	FlowBase1D(ThermoPhase* ph = 0, size_t nsp = 1, size_t points = 1);

    //! Delegating constructor
	FlowBase1D(shared_ptr<ThermoPhase> th, size_t nsp = 1, size_t points = 1) :
		FlowBase1D(th.get(), nsp, points) {
    }
    ...
    virtual void setFixedPoint(int j0, doublereal t0) {
        ...
        warn_deprecated("FlowBase1D::setFixedPoint",
